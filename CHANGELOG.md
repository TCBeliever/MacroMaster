...
- **Settings** window (left pane) with a language switch — auto / English / 繁體中文, applied after a UI reload; shipped template names and descriptions you never edited follow the language — and the doors to *Default templates* and *Export / Import*, which moved there from the left pane.
